...
public class FacturaVista extends javax.swing.JFrame {
    ...
    private controlador.ClienteControlador clienteControlador;
    private java.util.ArrayList<String[]> listaClientes;

    private controlador.ProductoControlador productoControlador;
    ...
    public FacturaVista() {
        ...
        clienteControlador = new controlador.ClienteControlador();
        cargarClientesEnCombo();
        
        productoControlador = new controlador.ProductoControlador();
    ...
    private void cmbClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbClientesActionPerformed
      ...
      private void cargarClientesEnCombo() {
        ...
        listaClientes = clienteControlador.obtenercliente();
        ...
        if (listaClientes != null && !listaClientes.isEmpty()) {
            for (String[] cliente : listaClientes) {
                ...
                String tipoCliente = cliente[4]; 
                
              
                cmbClientes.addItem(nombre + " (" + tipoCliente + ")");
            }
        } else {
            cmbClientes.addItem("No hay clientes registrados");
        }
    ...
    if (listaProductos != null && index >= 0 && index < listaProductos.size()) {
        modelo.Producto productoSeleccionado = listaProductos.get(index);
    ...
    listaProductos = productoControlador.obtenerTodosProductos();
    ...
    if (listaProductos != null && !listaProductos.isEmpty()) {
        ...
        cmbProductos.addItem("No hay productos");
    }
