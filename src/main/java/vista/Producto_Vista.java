...
public class Producto_Vista extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Producto_Vista.class.getName());

    /**
     * Creates new form Producto_Vista
     */
   ...
   controlador.insertarProducto(p);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Producto_Vista().setVisible(true));
    }
